...
@pytest.mark.parametrize(
    "context, expected_min_difficulty, expected_max_difficulty", contexts
)
def test_decide_difficulty(context, expected_min_difficulty, expected_max_difficulty):
    ...
    # Assert
    assert (
        difficulty >= expected_min_difficulty
    ), "Difficulty was lower than the minimum"
    assert (
        difficulty <= expected_max_difficulty
    ), "Difficulty was higher then the maximum"
